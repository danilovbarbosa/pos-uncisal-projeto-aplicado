...
variable "instance_cpus" {
  ...
  validation {
    ...
    error_message = "A free tier da OCI permite no máximo 2 OCPUs por instância A1."
  }
}
...
variable "instance_memory_gb" {
  ...
  validation {
    ...
    error_message = "A free tier da OCI permite no máximo 12 GB de RAM por instância A1."
  }
}
